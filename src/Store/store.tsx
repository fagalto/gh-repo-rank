...
import { filterState, RootState, userDetailInfo,repoEvent,sortedBy } from "./types";
...
export const mapDispatcherToProps = (dispatch: Dispatch<filterActions>) => {
  return {
    ...
    setSortedArray: (sorted: userDetailInfo[], item:sortedBy) => asyncactions.setSortedCommunity(dispatch,sorted,item)
  };
};
